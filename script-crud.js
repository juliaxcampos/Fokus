...
const cancelarAdicionarTarefaBt = document.querySelector('.app__form-footer__button--cancel');
const paragrafoDaDescricaoDaTarefa = document.querySelector('.app__section-active-task-description');
    ...
    if (tarefa.completa) {
        ...
        li.onclick = () => {
            ...
            if (tarefaSelecionada == tarefa){
                paragrafoDaDescricaoDaTarefa.textContent = '';
            ...
            paragrafoDaDescricaoDaTarefa.textContent = tarefa.descricao;
...
cancelarAdicionarTarefaBt.addEventListener('click', () =>{
    esconderForm()
});
